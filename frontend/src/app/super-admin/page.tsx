...
export default function SuperAdminDashboard() {
  ...
  useEffect(() => {
    if (localStorage.getItem('role') !== 'super_admin') return router.push('/login');
    api.get('/api/super-admin/societies').then(res => { setSocieties(res.data); setLoading(false); });
  }, []);
  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto p-8">
        <div className="mb-8"><h1 className="text-3xl font-bold">Society Management</h1><p className="text-gray-500 mt-1">Overview of all registered societies</p></div>
