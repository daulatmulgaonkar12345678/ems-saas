          ...
          <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
            <table className="w-full text-left">
              <thead className="bg-gray-800/50">
                <tr>
                  <th className="px-6 py-4 text-xs font-medium text-gray-400 uppercase">Society Name</th>
                  <th className="px-6 py-4 text-xs font-medium text-gray-400 uppercase">Location</th>
                  <th className="px-6 py-4 text-xs font-medium text-gray-400 uppercase">Plan</th>
                  <th className="px-6 py-4 text-xs font-medium text-gray-400 uppercase">Status</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-800">
                {societies.map((soc: any) => (
                  <tr key={soc.name} className="hover:bg-gray-800/30">
