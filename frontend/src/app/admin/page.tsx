        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          <div className="xl:col-span-2 space-y-6">
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
              <h2 className="text-lg font-bold text-white mb-5 flex items-center gap-2">Ã°Å¸â€œÂ¡ Pi Control</h2>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            ...
                            <div className="flex gap-2 mt-1">
                              ...
                              {isActive && <span className="text-xs font-bold px-2.5 py-0.5 rounded-full bg-cyan-500/20 text-cyan-400 flex items-center gap-1">Ã¢Ëœâ€¦ ACTIVE</span>}
                            </div>
                          </div>
                        </div>
                      </div>
            ...
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
              <h2 className="text-lg font-bold text-white mb-5 flex items-center gap-2">Ã¢Å¡â„¢Ã¯Â¸Â System Controls</h2>
              <div className="grid grid-cols-3 gap-3">
                <button onClick={() => sendCommand("/status")} className="p-3 bg-gray-800/50 hover:bg-gray-700 rounded-xl text-gray-300 text-xs font-semibold flex flex-col items-center gap-1 hover:border-cyan-500/50 hover:text-cyan-400 transition-all"><span className="text-xl">Ã°Å¸Å¸Â¢</span> Status</button>
                <button onClick={() => sendCommand("/control/force_on")} className="p-3 bg-gray-800/50 hover:bg-gray-700 rounded-xl text-gray-300 text-xs font-semibold flex flex-col items-center gap-1 hover:border-cyan-500/50 hover:text-cyan-400 transition-all"><span className="text-xl">Ã°Å¸â€™Â¡</span> Force ON</button>
                <button onClick={() => sendCommand("/control/reset")} className="p-3 bg-gray-800/50 hover:bg-gray-700 rounded-xl text-yellow-400 text-xs font-semibold flex flex-col items-center gap-1 hover:border-yellow-500/50 transition-all"><span className="text-xl">Ã°Å¸â€â€ž</span> Reset Days</button>
                <button onClick={() => sendCommand("/control/off_all")} className="p-3 bg-gray-800/50 hover:bg-red-900/30 rounded-xl text-red-400 text-xs font-semibold flex flex-col items-center gap-1 transition-all"><span className="text-xl">Ã°Å¸â€”â€˜</span> OFF All</button>
                <button onClick={() => sendCommand("/control/estop")} className="p-3 bg-red-900/30 hover:bg-red-900/50 rounded-xl text-red-400 text-xs font-semibold flex flex-col items-center gap-1 transition-all"><span className="text-xl">Ã¢Å¡Â Ã¯Â¸Â</span> E-Stop</button>
                <button onClick={() => sendCommand("/control/reboot_device")} className="p-3 bg-gray-800/50 hover:bg-gray-700 rounded-xl text-gray-300 text-xs font-semibold flex flex-col items-center gap-1 hover:border-cyan-500/50 hover:text-cyan-400 transition-all"><span className="text-xl">Ã°Å¸â€â€ž</span> Reboot Pi</button>
              </div>
            </div>
          </div>
          <div className="space-y-6">
            <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
              <h2 className="text-lg font-bold text-white mb-5">Ã°Å¸â€™Â¬ Device Response</h2>
